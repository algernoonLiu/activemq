...
public class Sender {
	...
	public static void main(String[] args) {
		...
		try {
			...
			Destination destination = session.createQueue("hello.first.queue");
			...
			for (int i = 0; i < 500000; i++) {
				...
				// 第四个参数 优先级
				// 第五个参数 消息的过期时间
				producer.send(destination, msg, DeliveryMode.NON_PERSISTENT, 0, 1000 * 60 * 30L);
